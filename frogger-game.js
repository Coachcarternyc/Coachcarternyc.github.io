...
function createStars() {
  ...
  starCreate(200, 100, "coin");
  starCreate(300, 150, "coin");
}
...
function createPoisons() {
  ...
  poisonCreate(250, 250, "poison");
  poisonCreate(325, 450, "poison");
  poisonCreate(100, 175, "poison");
}
...
window.onload = function() {
  ...
  function create() {
    ...
    scoreText = game.add.text(16, 16, "SCORE: " + currentScore, {
      font: "24px Arial",
      fill: "white"
    });
    livesText = game.add.text(685, 16, "LIVES: " + lives, {
      font: "24px Arial",
      fill: "white"
    });

    finalMessage = game.add.text(game.world.centerX, 250, "", {
      font: "48px Arial",
      fill: "white"
    });
